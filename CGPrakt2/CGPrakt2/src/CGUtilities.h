...
public:
    ...
    Material(const Color& Diffuse, const Color& Specular, const Color& Ambient, float SpecularExp, float Reflectivity, float Transmission);
    ...
    virtual float getTransmission(const Vector& Pos) const;
