...
Material::Material(const Color& Diffuse, const Color& Specular, const Color& Ambient, float SpecularExp, float Reflectivity, float Transmission)
{
    m_DiffuseCoeff = Diffuse;
    m_SpecularCoeff = Specular;
    m_AmbientCoeff = Ambient;
...
float Material::getTransmission(const Vector& Pos) const
{
